...
class Cache {
    ...
    constructor(config) {
        ...
        if (config) {
            ...
            __classPrivateFieldSet(this, _Cache_onDeleteExpired, config.onDeleteExpired
                ? config.onDeleteExpired.bind(this)
                : undefined, "f");
    ...
    }, _Cache_updateLRU = function _Cache_updateLRU(entry, evictLRU) {
    ...
    getDefaultExp(exp, maxAge) {
        ...
        const defaultExp = (_a = exp !== null && exp !== void 0 ? exp : (maxAge ? __classPrivateFieldGet(this, _Cache_now, "f").call(this) + maxAge : null)) !== null && _a !== void 0 ? _a : __classPrivateFieldGet(this, _Cache_defaultExp, "f").call(this);
        return defaultExp;
    }
    /**
    ...
    has(key, options) {
        ...
        if (entry) {
            const expired = (options === null || options === void 0 ? void 0 : options.expired) != null ? options === null || options === void 0 ? void 0 : options.expired : __classPrivateFieldGet(this, _Cache_getExpired, "f");
            if (expired) {
                return true;
            }
            const now = this.now();
        ...
        if (entry && entry.exp) {
            ...
            if (exp <= now) {
                ...
                if (deleteExpired) {
                    ...
                    __classPrivateFieldGet(this, _Cache_instances, "m", _Cache_updateLRU).call(this, entry);
                }
    ...
    set(key, value, options) {
        ...
        if (existingEntry) {
            ...
            __classPrivateFieldGet(this, _Cache_instances, "m", _Cache_updateLRU).call(this, existingEntry);
        }
        else {
            ...
            __classPrivateFieldGet(this, _Cache_instances, "m", _Cache_updateLRU).call(this, entry, true);
        }
    }
    /**
    ...
    update(key, changes) {
        ...
        const entry = __classPrivateFieldGet(this, _Cache_store, "f").get(key);
        if (entry != null) {
            if (typeof changes.exp !== "undefined" || typeof changes.maxAge !== "undefined") {
